...
const Page = () => {
    return (
        <Layout activePage="tudomanyos-hatter" anotherLanguagePage="scientific-background" requestedLanguage="hu">
            <h2>A TERMÉKEINKET MEGALAPOZÓ TALÁLMÁNY</h2>
            <p>
            ...
            <p>
                A projektben részt vevő magyar kutatóknak speciális eljárást sikerült kifejleszteniük, mellyel minden korábbinál tisztább ("hipertiszta") klór-dioxid (ClO<sub>2</sub>) oldat állítható elő. Erre az ún. membránpermeációs eljárásra a projektet vezető dr. Noszticzius Zoltán (BME) és munkatársai találmányi bejelentést tettek.
            </p>
            <p>
            ...
            <h2>A KLÓR-DIOXID NÉHÁNY ISMERT TULAJDONSÁGA</h2>
            <p>
                A klór-dioxid (ClO<sub>2</sub>) vizes oldata a világ egyik leghatékonyabb fertőtlenítőszereként ismert. [5][6]<br />
            ...
            <p>
                A klór-dioxid az Atlantai Toxikológiai Központ kiadványa szerint nem rákkeltő [16].<br />
                Ugyanezen kiadvány szerint a klór-dioxid nem okoz allergiás reakciót sem [16].<br />
            ...
            <h2>A KLÓR-DIOXID NÉHÁNY GYAKORLATI ALKALMAZÁSA</h2>
            <p>
                A klór-dioxid (ClO<sub>2</sub>) régóta ismert vegyület. Elsőként Sir Humphrey Davy állította elő 1811-ben, jelentőségre azonban csak a XX. században tett szert.
            </p>
            <p>
            ...
            <h2>KLÓR-DIOXIDOS SZÁJVIZEK VILÁGSZERTE</h2>
            <p>
                Jelenleg a világon több olyan szájvíz is forgalomban van, melynek hatóanyaga a klór-dioxid. Tudományos körökben terjed az álláspont, hogy a klór-dioxid a leghatékonyabb
                anyag erre a célra. [25]
            </p>
            <p>
            ...
            <p>
                Az említett tanulmányban vizsgált szájvizek azonban klór-dioxidot általában nem (vagy csak nyomokban) tartalmaznak, helyette nátrium-klorit (NaClO<sub>2</sub>) található bennük. [27] A nátrium-klorit viszont csak közvetve tud hatni a szájszagra, azáltal, hogy csökkenti a szájszagot termelő baktériumok számát.
            </p>
            <p>
            ...
            <h2>MIÉRT VESZÉLYTELEN A SOLUMIUM?</h2>
            <p>
            ...
            <h2>MI A HIPERTISZTA KLÓR-DIOXID?</h2>
            <p>
            ...
            <p>
                Az így előálló hipertiszta oldat egyrészt stabil (azaz csak lassan boomlik el), másrészt nem allergizál és nem irritál.
            </p>
            <h2>A HIPERTISZTA KLÓR-DIOXID ELŐNYEI</h2>
            <p>
                A klór-dioxid hagyományos előállítási módjaihoz képest a hipertiszta klór-dioxid szabadalmaztatott előállítási módja számos előnnyel jár:<br />
                - a gyártáskor immár nem juthatnak szennyezőanyagok a termékbe;<br />
                - a kiindulási vegyületek sem szennyezhetik a terméket;<br />
                - a gyártott oldat mentes mindennemű visszamaradó savtól [28] (melyek amúgy veszélyeztetnék a fogzománcot [29]);<br />
            ...
            <p>
                A gyártási eljárás magyar találmányon alapul, mely immár szabadalmi védelmet élvez a világ számos országában, pl. az Egyesült Államokban és Kínában is. [1] [2] [3]<br />
