...
const Page = () => {
    return (
        <Layout activePage="scientific-background" anotherLanguagePage="tudomanyos-hatter" requestedLanguage="en">
            <h2>THE INVENTION BEHIND OUR PRODUCTS</h2>
            <p>
            ...
            <h2>CHLORINE DIOXIDE: SOME OF IT'S WELL-KNOWN PROPERTIES</h2>
            <p>
                The aqueous solution of chlorine dioxide (ClO<sub>2</sub>) is known to be one of the most effective disinfectants in the world. [5][6]<br />
            ...
            <p>
                Chlorine dioxide is not carcinogenic. This is stated in a 2004 publication by the Agency for Toxic Substances and Disease Registry [16]. The same publication also states that chlorine dioxide does not cause an allergic reaction [16].<br />
            ...
            <h2>PRACTICAL APPLICATIONS OF CHLORINE DIOXIDE</h2>
            <p>
                Chlorine dioxide (ClO<sub>2</sub>) has long been known. It was first produced by Sir Humphrey Davy in 1811, but it gained importance only in the 20th century.
            </p>
            <p>
            ...
            <h2>CHLORINE DIOXIDE MOUTHWASHES IN THE WORLD</h2>
            <p>
            ...
            <p>
                The mouthwashes in the above study, however, usually contain no chlorine dioxide (or trace amounts only): instead they contain sodium chlorite (NaClO<sub>2</sub>) [27]. Sodium chlorite, however, can only affect bad breath indirectly, by reducing the number of bacteria that produce it.
            </p>
            <p>
            ...
            <h2>WHY SOLUMIUM IS SAFE</h2>
            <p>
                An aqueous solution of chlorine dioxide with a concentration of less than 0.3% is not a hazardous substance according to the CLP Regulation of the European Union [19].<br />
            ...
            <h2>WHAT IS HYPERPURE CHLORINE DIOXIDE?</h2>
            <p>
            ...
            <h2>ADVANTAGES OF HYPERPURE CHLORINE DIOXIDE</h2>
            <p>
                Compared to conventional methods of producing chlorine dioxide, the patented method of producing hyperpure chlorine dioxide has several advantages:<br />
                - no contaminants can enter the product during manufacture;<br />
                - the starting compounds can not contaminate the product either;<br />
                - the solution produced is free of any residual acid [28] (which would otherwise endanger tooth enamel [29]);<br />
            ...
            <h2>WHAT MAKES SOLUMUM UNIQUE?</h2>
            <p>
